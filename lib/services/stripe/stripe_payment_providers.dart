...
import 'stripe_boutique_payment_service.dart';
...
final stripeBoutiquePaymentServiceProvider =
    Provider<StripeBoutiquePaymentService?>((ref) {
  if (!AppConfig.hasSupabase || !StripePlatformPolicy.isEnabled) return null;
  return StripeBoutiquePaymentService(SupabaseService.client);
});
