...
class StripeBookingPaymentService {
  ...
  Future<void> presentPaymentSheet(BookingPaymentSheetData sheet) async {
    if (kIsWeb) {
      throw const StripePaymentGenericException(
        'PaymentSheet indisponible sur le web',
      );
    }
    if (!StripePlatformPolicy.isEnabled) {
      throw const StripePaymentGenericException(DiscPay.errWebUnsupported);
      ...
      await Stripe.instance.initPaymentSheet(
        paymentSheetParameters: SetupPaymentSheetParameters(
          ...
          googlePay: PaymentSheetGooglePay(
            ...
            testEnv: StripeService.isTestMode,
          ),
        ),
      );
  ...
  static String bookingInstantPayload(DateTime dateHeure) =>
      _bookingInstantPayload(dateHeure);
