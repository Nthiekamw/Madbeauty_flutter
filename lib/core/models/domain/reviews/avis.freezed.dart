...
mixin _$Avis {
 ...
 String get id; String get clientId; String get prestataireId; String get reservationId; int get note; String? get commentaire;@IsoDateTimeConverter() DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,clientId,prestataireId,reservationId,note,commentaire,createdAt);

@override
String toString() {
  return 'Avis(id: $id, clientId: $clientId, prestataireId: $prestataireId, reservationId: $reservationId, note: $note, commentaire: $commentaire, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String clientId, String prestataireId, String reservationId, int note, String? commentaire,@IsoDateTimeConverter() DateTime createdAt
});
...
/// Create a copy of Avis
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? clientId = null,Object? prestataireId = null,Object? reservationId = null,Object? note = null,Object? commentaire = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String clientId,  String prestataireId,  String reservationId,  int note,  String? commentaire, @IsoDateTimeConverter()  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Avis() when $default != null:
return $default(_that.id,_that.clientId,_that.prestataireId,_that.reservationId,_that.note,_that.commentaire,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String clientId,  String prestataireId,  String reservationId,  int note,  String? commentaire, @IsoDateTimeConverter()  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _Avis():
return $default(_that.id,_that.clientId,_that.prestataireId,_that.reservationId,_that.note,_that.commentaire,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String clientId,  String prestataireId,  String reservationId,  int note,  String? commentaire, @IsoDateTimeConverter()  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Avis() when $default != null:
return $default(_that.id,_that.clientId,_that.prestataireId,_that.reservationId,_that.note,_that.commentaire,_that.createdAt);case _:
  return null;
...
class _Avis implements Avis {
  const _Avis({required this.id, required this.clientId, required this.prestataireId, required this.reservationId, required this.note, this.commentaire, @IsoDateTimeConverter() required this.createdAt});
...
/// Create a copy of Avis
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? clientId = null,Object? prestataireId = null,Object? reservationId = null,Object? note = null,Object? commentaire = freezed,Object? createdAt = null,}) {
  return _then(_Avis(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,clientId: null == clientId ? _self.clientId : clientId // ignore: cast_nullable_to_non_nullable
as String,prestataireId: null == prestataireId ? _self.prestataireId : prestataireId // ignore: cast_nullable_to_non_nullable
