...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,nomSalon,bio,ville,adresse,codePostal,pays,nomAffiche,publicSlug,lieuTravail,anneesExperience,experienceProfessionnelle,description,const DeepCollectionEquality().hash(confortClient),const DeepCollectionEquality().hash(conditionsService),latitude,longitude,noteMoyenne,isVerified,createdAt]);

@override
String toString() {
  return 'PrestataireProfile(id: $id, userId: $userId, nomSalon: $nomSalon, bio: $bio, ville: $ville, adresse: $adresse, codePostal: $codePostal, pays: $pays, nomAffiche: $nomAffiche, publicSlug: $publicSlug, lieuTravail: $lieuTravail, anneesExperience: $anneesExperience, experienceProfessionnelle: $experienceProfessionnelle, description: $description, confortClient: $confortClient, conditionsService: $conditionsService, latitude: $latitude, longitude: $longitude, noteMoyenne: $noteMoyenne, isVerified: $isVerified, createdAt: $createdAt)';
}
...
@override@JsonKey(name: 'public_slug') final  String? publicSlug;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,nomSalon,bio,ville,adresse,codePostal,pays,nomAffiche,publicSlug,lieuTravail,anneesExperience,experienceProfessionnelle,description,const DeepCollectionEquality().hash(_confortClient),const DeepCollectionEquality().hash(_conditionsService),latitude,longitude,noteMoyenne,isVerified,createdAt]);
