...
class ListingActiveFiltersBar extends ConsumerWidget {
  ...
  List<Widget> _buildChips(
    ...
    if (filters.favoritesOnly) {
      addChip(DiscFavori.profileSectionTitle, () {
        ref.read(prestatairesFilterProvider.notifier).resetQuickFilters();
      });
    }

    if (filters.likedOnly) {
      addChip(DiscLike.filterPreferred, () {
        ref.read(prestatairesFilterProvider.notifier).resetQuickFilters();
      });
    }
    ...
    if (quickId != null && quickId != 'all') {
      ...
      if (quick != null &&
          ...
          quick.kind != ListingQuickFilterKind.favoritesOnly &&
          quick.kind != ListingQuickFilterKind.likedOnly &&
