...
class _SA extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Center(child: Text('$num', style: TextStyle(
      color: Colors.white, fontWeight: FontWeight.w700, fontSize: rem * 3.5))));
}
...
class _SG extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    width: rem * 8, height: rem * 8,
    decoration: BoxDecoration(
      shape: BoxShape.circle, color: const Color(0xFFEDE0CC)),
    child: Center(child: Text('$num', style: TextStyle(
      color: _textGrey, fontWeight: FontWeight.w700, fontSize: rem * 3.5))));
}
