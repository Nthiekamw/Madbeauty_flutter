            ...
            child: Wrap(
              ...
              children: [
                for (final option in comforts)
                  _ComfortChip(option: option, accent: tertiary, isDark: isDark),
              ],
            ),
          ),
        ],
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: theme.colorScheme.outline.withValues(alpha: isDark ? 0.14 : 0.09),
        ),
        boxShadow: isDark
            ? null
            : [
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(
            ...
            indent: 18,
            endIndent: 18,
            color: theme.colorScheme.outline.withValues(alpha: isDark ? 0.1 : 0.07),
          ),
          Padding(
