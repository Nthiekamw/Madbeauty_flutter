...
// ── Palette ───────────────────────────────────────────────────────────────────
const _brown      = Color(0xFF2C1810); // fond sombre header / nav
const _brownMid   = Color(0xFF3D2314);
const _gold       = Color(0xFFC4956A);
const _goldLight  = Color(0xFFEDE0CC);
const _goldDark   = Color(0xFF8B6340);
const _textDark   = Color(0xFF1A0A00);
const _textGrey   = Color(0xFF9E8878);
const _bg         = Color(0xFFF5EFE8); // fond général crème
const _cardBg     = Color(0xFFFFFFFF);
const _iconCircle = Color(0xFF3D2314); // icônes stats sombres
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        // ── HEADER avec fond sombre + dégradé ──────────────────────────
        _Header(rem: rem),
...
class _Header extends StatelessWidget {
  const _Header({required this.rem});
  final double rem;

  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: rem * 38, // hauteur généreuse comme dans le design
      child: Stack(
        fit: StackFit.expand,
        children: [
            ...
            errorBuilder: (_, __, ___) => Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [Color(0xFF3D1810), Color(0xFF1A0800)],
                ),
              ),
            ),
          ),

          // ── Dégradé : transparent en haut → brun foncé en bas ───────
          Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Ligne 1 : icônes utilitaires (thème, aide, déco)
                  Row(
                    ...
                    children: [
                      ...
                      _HdrPopup(
                        ...
                        rem: rem,
                        items: [
                          PopupMenuItem(value: 'light',  child: Row(children: [Icon(Icons.wb_sunny_outlined, size: 18), SizedBox(width: 10), Text('Clair')])),
                          PopupMenuItem(value: 'dark',   child: Row(children: [Icon(Icons.nightlight_round,  size: 18), SizedBox(width: 10), Text('Sombre')])),
                          PopupMenuItem(value: 'system', child: Row(children: [Icon(Icons.monitor,           size: 18), SizedBox(width: 10), Text('Système')])),
                        ],
                        onSelected: (_) {},
                      ),
                      ...
                      _HdrPopup(
                        ...
                        rem: rem,
                        items: [
                          PopupMenuItem(value: 'new',  child: Row(children: [Icon(Icons.chat_bubble_outline, size: 18), SizedBox(width: 10), Text('Nouveau ticket')])),
                          PopupMenuItem(value: 'list', child: Row(children: [Icon(Icons.flag_outlined,       size: 18), SizedBox(width: 10), Text('Mes tickets (0)')])),
                        ],
                        onSelected: (_) {},
                      ),
                      SizedBox(width: rem * 1.5),
                  ...
                  // Ligne 2 : profil + nom + notifications
                  Row(
                    children: [
                      // Avatar
                      Container(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Row(children: [
                              Text('Bonjour Wil', style: TextStyle(
                                fontSize: rem * 5.2,
                            ...
                            Row(children: [
                              Text('Espace Coiffeur', style: TextStyle(
                                fontSize: rem * 3.2,
                                color: Colors.white.withOpacity(0.85),
                                fontWeight: FontWeight.w500,
                              )),
                              SizedBox(width: rem * 1.5),
                              Icon(Icons.verified_rounded, color: _gold, size: rem * 4),
                            ]),
                          ],
                        ),
                      ),
                      ...
                      _HeaderIconBadge(
                        ...
                        onTap: () => showDialog(
                          ...
                          builder: (_) => AlertDialog(
                            ...
                            content: const Text('3 nouvelles notifications'),
...
// Bouton icône simple dans le header (transparent)
class _HdrIconBtn extends StatelessWidget {
  const _HdrIconBtn({required this.icon, required this.rem, required this.onTap});
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      child: Icon(icon, color: Colors.white, size: rem * 4.8),
    ),
  );
}

// PopupMenu icône dans le header
class _HdrPopup extends StatelessWidget {
  const _HdrPopup({required this.icon, required this.rem, required this.items, required this.onSelected});
  final IconData icon; final double rem;
...
class _HeaderIconBadge extends StatelessWidget {
  const _HeaderIconBadge({required this.icon, required this.count, required this.rem, required this.onTap});
  final IconData icon;
  final int count;
  final double rem;
      ...
      child: Stack(
        ...
        children: [
          Container(
            ...
            child: Icon(icon, color: Colors.white, size: rem * 5.5),
          ),
          if (count > 0)
            Positioned(
              top: -rem * 0.5,
              ...
              child: Container(
                ...
                child: Text('$count', style: TextStyle(
                  color: Colors.white, fontSize: rem * 2.2, fontWeight: FontWeight.w800)),
              ),
            ),
        ],
      ),
...
class _BottomNav extends StatelessWidget {
  const _BottomNav({required this.current, required this.onTap, required this.rem});
  final int current;
    ...
    return Container(
      ...
      child: SafeArea(
        ...
        child: Padding(
          ...
          child: Row(children: [
            _NavItem(icon: Icons.home_rounded,           label: 'Accueil',     index: 0, current: current, onTap: onTap, rem: rem),
            _NavItem(icon: Icons.calendar_today_rounded, label: 'Rendez-vous', index: 1, current: current, onTap: onTap, rem: rem),
            _NavItem(icon: Icons.chat_bubble_rounded,    label: 'Chat',        index: 2, current: current, onTap: onTap, rem: rem),
            _NavItem(icon: Icons.people_rounded,         label: 'Clients',     index: 3, current: current, onTap: onTap, rem: rem),
            _NavItem(icon: Icons.person_rounded,         label: 'Profil',      index: 4, current: current, onTap: onTap, rem: rem),
          ]),
        ),
      ),
    );
...
class _NavItem extends StatelessWidget {
  const _NavItem({required this.icon, required this.label, required this.index,
    required this.current, required this.onTap, required this.rem});
  final IconData icon;
  final String label;
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Column(
          ...
          children: [
            Icon(icon, size: rem * 6,
              color: active ? _gold : Colors.white.withOpacity(0.45)),
            SizedBox(height: rem * 0.8),
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        // ── Fond crème avec arrondi en haut ──────────────────────────
        Container(
          color: const Color(0xFF1A0800),
          child: Container(
            decoration: const BoxDecoration(
            ...
            child: Column(children: [
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(children: [
                        Container(
                          ...
                          child: Icon(Icons.error_outline_rounded, color: Colors.red, size: rem * 4.5)),
                        SizedBox(width: rem * 3),
                        ...
                        Icon(Icons.chevron_right_rounded, color: _textGrey, size: rem * 5.5),
                      ]),
                      SizedBox(height: rem * 2.5),
                      Text('Complétez votre profil pour commencer\nà recevoir des réservations.',
                      ...
                      Row(children: [
                        ...
                        const Spacer(),
                        Text('60%', style: TextStyle(fontSize: rem * 3, fontWeight: FontWeight.w700, color: _textDark)),
                      ]),
                      SizedBox(height: rem * 1.5),
                      ClipRRect(
                        borderRadius: BorderRadius.circular(rem),
                        child: LinearProgressIndicator(
                          value: 0.6, minHeight: rem * 1.5,
                          backgroundColor: Colors.red.withOpacity(0.12),
                          valueColor: const AlwaysStoppedAnimation(Colors.red))),
                      SizedBox(height: rem * 3),
                      Wrap(spacing: rem * 1.5, runSpacing: rem * 1.5, children: const [
                        _Chip(label: '• Services',              done: false),
                        _Chip(label: '• Réalisations',          done: false),
                        _Chip(label: '• Disponibilités',        done: false),
                        _Chip(label: '• Photo de profil',       done: false),
                        _Chip(label: '+ Conditions de service', done: true),
                        _Chip(label: '+ Confort client',        done: true),
                        _Chip(label: '• Abonnement Pro',        done: false),
                        _Chip(label: '+ Paiements en ligne',    done: true),
                      ]),
                    ]),
                  ),
                ),
              ...
              // ── Section "Aperçu" ──────────────────────────────────
              Padding(
                padding: EdgeInsets.fromLTRB(rem * 4, rem * 5, rem * 4, 0),
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFF2C1205), Color(0xFF3D1F0D)],
                        begin: Alignment.centerLeft, end: Alignment.centerRight),
                      borderRadius: BorderRadius.circular(rem * 4),
                    ),
                    child: Row(children: [
                      Text('👑', style: TextStyle(fontSize: rem * 9)),
                      SizedBox(width: rem * 3),
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(children: [
                          Text('Développez votre activité', style: TextStyle(
                            fontSize: rem * 3.8, fontWeight: FontWeight.w800, color: Colors.white)),
                          SizedBox(width: rem * 1.5),
                          Text('✨', style: TextStyle(fontSize: rem * 3.5)),
                        ]),
                        SizedBox(height: rem * 1.5),
                        Text('Complétez votre profil à 100% et\nattirez plus de clients.',
                          style: TextStyle(fontSize: rem * 3, color: Colors.white.withOpacity(0.7), height: 1.4)),
                      ])),
                      ...
                      Stack(alignment: Alignment.center, children: [
                        SizedBox(
                          ...
                          child: CircularProgressIndicator(
                            value: 0.75, strokeWidth: rem * 1.2,
                            backgroundColor: Colors.white.withOpacity(0.2),
                            valueColor: const AlwaysStoppedAnimation(_gold))),
                        Text('75%', style: TextStyle(
                          fontSize: rem * 3, fontWeight: FontWeight.w800, color: Colors.white)),
                      ]),
                      SizedBox(width: rem * 2),
                      Icon(Icons.chevron_right_rounded, color: Colors.white.withOpacity(0.6), size: rem * 5.5),
                    ]),
                  ),
                ),
              ),
              ...
              Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      _TodayItem(icon: Icons.person_add_alt_1_rounded, label: 'Nouveau client', value: '1', rem: rem),
                      _TodayDivider(),
                      _TodayItem(icon: Icons.calendar_today_rounded,   label: 'Réservations',  value: '2', rem: rem),
                      _TodayDivider(),
                      _TodayItem(icon: Icons.euro_rounded,             label: 'Revenus du jour',value: '+120 €', rem: rem),
                      _TodayDivider(),
                      _TodayItem(icon: Icons.star_rounded,             label: 'Avis reçus',     value: '1', rem: rem),
                    ]),
                  ),
                ]),
              ),

              // ── Sections profil (Services, Dispo, etc.) ───────────
              Padding(
                padding: EdgeInsets.fromLTRB(rem * 4, rem * 5, rem * 4, rem * 2),
              ...
              Padding(
                ...
                child: Column(children: [
                  ...
                  _SectionCard2(
                    ...
                    emptyText: 'Aucune disponibilité configurée',
                    btnText: 'Remplir mes disponibilités',
                    rem: rem,
                    onTap: () => context.go('/prestataire/onboarding')),
                  SizedBox(height: rem * 3),
                  _SectionCard2(
                    icon: Icons.photo_camera_outlined,
                    title: 'Réalisations (0/10)',
                  ...
                  _SectionCard2(
                    ...
                    title: 'Conditions',
                    emptyText: 'Aucune condition définie',
                    btnText: 'Définir mes conditions',
                    rem: rem,
                    onTap: () => context.go('/prestataire/onboarding')),
                  SizedBox(height: rem * 3),
                  _SectionCard2(
                    icon: Icons.star_outline_rounded,
                    title: 'Confort client',
                    emptyText: 'Aucun service de confort',
                    btnText: 'Ajouter des commodités',
                    rem: rem,
                    onTap: () => context.go('/prestataire/onboarding')),
...
class _TodayDivider extends StatelessWidget {
  @override
  Widget build(BuildContext context) =>
    Container(width: 1, height: 48, color: const Color(0xFFEDE0CC));
}

class _TodayItem extends StatelessWidget {
  const _TodayItem({required this.icon, required this.label, required this.value, required this.rem});
  final IconData icon; final String label, value; final double rem;

  @override
  Widget build(BuildContext context) => Expanded(
    child: Column(children: [
      Icon(icon, size: rem * 5.5, color: _textGrey),
      SizedBox(height: rem * 1.2),
      Text(label, textAlign: TextAlign.center, style: TextStyle(fontSize: rem * 2.6, color: _textGrey)),
      SizedBox(height: rem * 1),
      Text(value, style: TextStyle(fontSize: rem * 4, fontWeight: FontWeight.w800, color: _textDark)),
      SizedBox(height: rem * 1),
...
class _StatCard2 extends StatelessWidget {
  const _StatCard2({required this.icon, required this.label, required this.value, required this.trend, required this.rem});
  final IconData icon; final String label, value, trend; final double rem;
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
        ...
        decoration: const BoxDecoration(color: _iconCircle, shape: BoxShape.circle),
        child: Icon(icon, size: rem * 4.5, color: _gold)),
      SizedBox(height: rem * 3),
      Text(value, style: TextStyle(
        fontSize: rem * 6, fontWeight: FontWeight.w800, color: _textDark,
        letterSpacing: -0.5)),
      SizedBox(height: rem * 0.5),
      Text(label, style: TextStyle(fontSize: rem * 3, color: _textGrey)),
      SizedBox(height: rem * 2),
      Container(
        padding: EdgeInsets.symmetric(horizontal: rem * 2, vertical: rem * 0.8),
        decoration: BoxDecoration(
          color: const Color(0xFFF5EFE8),
          borderRadius: BorderRadius.circular(rem * 3)),
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          Icon(Icons.north_east_rounded, size: rem * 3, color: _goldDark),
          SizedBox(width: rem * 0.8),
          Text(trend, style: TextStyle(fontSize: rem * 2.6, color: _goldDark, fontWeight: FontWeight.w600)),
        ]),
      ),
    ]),
  );
...
class _Chip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      color: done ? const Color(0xFFEDF7ED) : const Color(0xFFFFEEEE),
      borderRadius: BorderRadius.circular(50),
      border: Border.all(color: done ? Colors.green.withOpacity(0.4) : Colors.red.withOpacity(0.4))),
    child: Text(label, style: TextStyle(
      fontSize: 12, fontWeight: FontWeight.w500,
      color: done ? Colors.green.shade700 : Colors.red)));
}
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        Container(
          ...
          child: Column(children: [
            Container(
              ...
              decoration: BoxDecoration(shape: BoxShape.circle, color: const Color(0xFF3D1F0D)),
              child: Icon(Icons.person_rounded, color: _gold, size: rem * 10)),
            SizedBox(height: rem * 3),
            Text('Wil', style: TextStyle(fontSize: rem * 5, fontWeight: FontWeight.w800, color: _textDark)),
            Text('Espace Coiffeur', style: TextStyle(fontSize: rem * 3.2, color: _textGrey)),
            ...
            OutlinedButton.icon(
              ...
              icon: Icon(Icons.edit_rounded, size: rem * 4, color: _textDark),
              label: Text('Modifier le profil', style: TextStyle(color: _textDark, fontSize: rem * 3.5)),
        ...
        SizedBox(height: rem * 3),
        _MenuTile(icon: Icons.refresh_rounded,        label: 'Actualiser les données', rem: rem, onTap: () {}),
        _MenuTile(icon: Icons.credit_card_outlined,   label: 'Mon abonnement',         rem: rem, onTap: () {}),
        _MenuTile(icon: Icons.share_outlined,         label: 'Partager mon profil',     rem: rem, onTap: () {}),
        _MenuTile(icon: Icons.help_outline_rounded,   label: 'Aide & Support',          rem: rem, onTap: () {}),
        _MenuTile(icon: Icons.logout_rounded,         label: 'Se déconnecter',          rem: rem, onTap: () => context.go('/'), isDestructive: false),
        _MenuTile(icon: Icons.delete_outline_rounded, label: 'Supprimer mon compte',    rem: rem, onTap: () {}, isDestructive: true),
        SizedBox(height: rem * 4),
      ]),
    );
  }
...
class _MenuTile extends StatelessWidget {
  const _MenuTile({required this.icon, required this.label, required this.rem, required this.onTap, this.isDestructive = false});
  final IconData icon; final String label; final double rem; final VoidCallback onTap; final bool isDestructive;
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      padding: EdgeInsets.all(rem * 4),
      decoration: BoxDecoration(
        color: isDestructive ? const Color(0xFFFFEEEE) : Colors.white,
        borderRadius: BorderRadius.circular(rem * 3.5),
        boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.04), blurRadius: 8)],
      ),
      child: Row(children: [
        Icon(icon, size: rem * 5, color: isDestructive ? Colors.red : _textDark),
        SizedBox(width: rem * 3),
        Text(label, style: TextStyle(
          fontSize: rem * 3.5, fontWeight: FontWeight.w600,
          color: isDestructive ? Colors.red : _textDark)),
        const Spacer(),
        Icon(Icons.chevron_right_rounded, size: rem * 5, color: _textGrey),
      ]),
    ),
  );
}
        ...
        child: ListView(controller: ctrl,
          ...
          Row(children: [
            Container(width: rem * 14, height: rem * 14,
              decoration: const BoxDecoration(shape: BoxShape.circle, color: Color(0xFF3D1F0D)),
              child: Icon(Icons.person_rounded, color: _gold, size: rem * 8)),
            SizedBox(width: rem * 3),
          ...
          Row(children: [
            ...
            Expanded(child: GestureDetector(
              ...
              child: Container(
                padding: EdgeInsets.symmetric(vertical: rem * 3.5),
                decoration: BoxDecoration(
                  color: _bg, borderRadius: BorderRadius.circular(rem * 5),
...
// ─── SECTION CARD (Mon profil) ───────────────────────────────────────────────
class _SectionCard2 extends StatelessWidget {
  const _SectionCard2({
    required this.icon,
    required this.title,
  ...
  final IconData icon;
  final String title, emptyText, btnText;
  final double rem;
  final VoidCallback onTap;
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Row(children: [
        ...
        Text(title, style: TextStyle(
          fontSize: rem * 3.8, fontWeight: FontWeight.w700, color: _textDark)),
      ]),
      SizedBox(height: rem * 3.5),
      // Texte vide
      Center(child: Text(emptyText, style: TextStyle(
      ...
      Center(child: GestureDetector(
        onTap: onTap,
        child: Container(
          padding: EdgeInsets.symmetric(horizontal: rem * 6, vertical: rem * 2.8),
          decoration: BoxDecoration(
            color: const Color(0xFF2C1810),
            borderRadius: BorderRadius.circular(rem * 8),
            boxShadow: [BoxShadow(
              color: const Color(0xFF2C1810).withOpacity(0.35),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(children: [
      Container(
        ...
        decoration: const BoxDecoration(color: Color(0xFF3D1F0D), shape: BoxShape.circle),
  ...
  Widget build(BuildContext context) => Expanded(
    child: GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.symmetric(vertical: rem * 3),
        decoration: BoxDecoration(
          color: active ? _brown : Colors.transparent,
          borderRadius: BorderRadius.circular(rem * 8)),
  ...
  Widget build(BuildContext context) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    ...
    TextField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(rem * 3), borderSide: BorderSide(color: _brown, width: 2)),
      )),
    SizedBox(height: rem * 4),
  ]);
}
...
//               // ── Section "Aujourd'hui" ─────────────────────────────
//               Padding(
//                 padding: EdgeInsets.fromLTRB(rem * 4, rem * 5, rem * 4, rem * 6),
//                 child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
//                   Text("Aujourd'hui", style: TextStyle(
//                     fontSize: rem * 4.5, fontWeight: FontWeight.w800, color: _textDark)),
//                   SizedBox(height: rem * 3),
...
//         child: Stack(
//           children: [
//             // ── Image de fond salon luxueux (asset local) ────────────
//             Positioned.fill(
//               child: Image.asset(
//                 'assets/images/salon_bg.jpg',
//                 fit: BoxFit.cover,
...
//                       begin: Alignment.topLeft,
//                       end: Alignment.bottomRight,
//                       colors: [Color(0xFF1A0800), Color(0xFF3D1F0D), Color(0xFF2C1205)],
//                     ),
//                   ),
//                 ),
//               ),
//             ),
//             // ── Overlay dégradé sombre doré pour lisibilité ───────────
//             Positioned.fill(
//               child: Container(
//                 decoration: BoxDecoration(
//                   gradient: LinearGradient(
...
//                       const Color(0xFF1A0800).withOpacity(0.78),
//                     ],
//                   ),
//                 ),
//               ),
//             ),
//             Padding(
//               padding: EdgeInsets.fromLTRB(rem * 4, rem * 3, rem * 4, rem * 4),
//               child: Row(
//                 children: [
//                   // Photo de profil
//                   Container(
