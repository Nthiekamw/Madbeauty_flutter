            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Center(
                child: Text(
                  ...
                  style: TextStyle(fontSize: 13, color: _brown, height: 1.4)),
              ),
              ...
              child: Column(children: [
                Row(children: [
                  if (_currentStep > 0)
                    OutlinedButton.icon(
                      onPressed: _prev,
                      icon: const Icon(Icons.chevron_left, size: 18, color: _brown),
                      label: const Text('Précédent', style: TextStyle(color: _brown)),
...
class _StepCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(children: [
      Container(
        width: 64, height: 64,
        decoration: const BoxDecoration(color: _brownLight, shape: BoxShape.circle),
        child: Icon(step.icon, color: _brown, size: 30),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isActive ? _brownLight : Colors.white,
          borderRadius: BorderRadius.circular(50),
          border: Border.all(
            color: isActive ? _brown : const Color(0xFFF0F0F0),
          ),
        ),
        child: Row(children: [
          Icon(step.icon, color: isActive ? _brown : _textGrey, size: 20),
