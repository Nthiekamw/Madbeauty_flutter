...
class _StepDisponibilitesState extends State<StepDisponibilites>
          ...
          children: [
            ...
            SingleChildScrollView(child: Column(children: [
              ...
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Row(children: [
                    Icon(Icons.access_time, color: _brown, size: 18),
                    SizedBox(width: 8),
            ...
            SingleChildScrollView(child: Column(children: [
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Row(children: [
                    Icon(Icons.calendar_month, color: _brown, size: 18),
                    SizedBox(width: 8),
  ...
  Widget _emptyState(IconData icon, String title, String sub) => Container(
    ...
    decoration: BoxDecoration(
      borderRadius: BorderRadius.circular(16),
      border: Border.all(color: _brown.withOpacity(0.3), style: BorderStyle.solid),
    ),
    child: Column(children: [
      Icon(icon, size: 40, color: _brown.withOpacity(0.4)),
      const SizedBox(height: 10),
      Text(title, textAlign: TextAlign.center,
        style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: _brown.withOpacity(0.7))),
      const SizedBox(height: 4),
      Text(sub, textAlign: TextAlign.center,
        style: TextStyle(fontSize: 12, color: _brown.withOpacity(0.6))),
    ]),
  );
}
...
class _DispoTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(12),
      border: Border.all(color: const Color(0xFF8B6340).withOpacity(0.3)),
    ),
    child: Row(children: [
      Icon(icon, color: const Color(0xFF8B6340), size: 18),
      const SizedBox(width: 10),
