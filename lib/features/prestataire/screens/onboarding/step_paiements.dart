  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      const Text('Acceptez les paiements en ligne',
        style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700, color: _brown, height: 1.3)),

      Padding(
        padding: const EdgeInsets.symmetric(vertical: 14),
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(width: 30, height: 3, decoration: BoxDecoration(color: _brown, borderRadius: BorderRadius.circular(2))),
          const SizedBox(width: 6),
          Container(width: 8, height: 8, decoration: BoxDecoration(color: _brown, shape: BoxShape.circle)),
          const SizedBox(width: 6),
          Container(width: 30, height: 3, decoration: BoxDecoration(color: _brown, borderRadius: BorderRadius.circular(2))),
        ]),
      ),
      ...
      ..._avantages.map((a) => Padding(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            ...
            child: const Icon(Icons.check, color: _brown, size: 16),
          ),
          const SizedBox(width: 12),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(a['title']!, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: _brown)),
      ...
      Container(
        ...
        child: const Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Icon(Icons.payment, color: _brown, size: 22),
          SizedBox(width: 12),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Row(children: [
            Icon(Icons.warning_amber_rounded, color: _brown, size: 18),
            SizedBox(width: 8),
            Text('Sans Abonnement Pro', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: _brown)),
          ]),
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(children: [
      Container(
        width: 28, height: 28,
        decoration: const BoxDecoration(color: Color(0xFFF2E8D9), shape: BoxShape.circle),
        child: const Icon(Icons.lock_outline, color: _brown, size: 16),
      ),
